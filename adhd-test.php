...
<body>
  ...
  <main class="flex-1 p-5 md:ml-[220px] md:mt-0 bg-[#f9f8f5] min-h-screen pt-20 md:pt-10">
    <section class="max-w-3xl mx-auto bg-white p-6 rounded-xl shadow-md mb-16 border border-[#d1bfa3]/50">
      ...
      <form id="adhdForm" class="space-y-6">
        <div class="mb-4">
          <p class="font-medium text-[#3d3d2f] mb-2">Email</p>
          <label class="block">
            <input type="email" name="name" placeholder="Enter your email address" class="w-full border border-[#d1bfa3]/70 rounded-lg px-4 py-2 bg-[#f9f8f5] 
