    ...
    <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div
            ...
            <div class="p-4">
                ...
                <p class="text-sm text-[#3d3d2f]">
                    A compact yet powerful drone perfect for capturing cinematic aerial shots with stunning stability.
                </p>
            </div>
        </div>
        ...
        <div
            ...
            <div class="p-4">
                ...
                <p class="text-sm text-[#3d3d2f]">
                    A next-gen smartphone gimbal offering smooth stabilization and creative shooting modes for vlogging.
                </p>
            </div>
        </div>
        ...
        <div
            ...
            <div class="p-4">
                ...
                <p class="text-sm text-[#3d3d2f]">
                    A reliable smartphone with crisp 5G connectivity and high-quality camera ideal for mobile content
                    creation.
                </p>
            </div>
        </div>
