<header class="md:hidden fixed top-0 left-0 right-0 z-50 bg-white/70 backdrop-blur-xl border-b border-neutral-200">
    <div class="flex items-center justify-between px-5 py-3">
        <div class="flex items-center gap-3">
            <img src="./assets/images/chadsvlog-logo.webp" alt="Logo"
                class="w-12 h-auto rounded-2xl shadow-md p-1">
            <div>
...
<nav
    ...
    <div class="flex items-center justify-around">
        <a href="./"
            class="flex flex-col items-center justify-center w-16 py-2 rounded-2xl bg-[#727b46] text-white shadow-lg">
            <i class="fa-solid fa-house text-lg"></i>
            <span class="text-[11px] mt-1 font-medium">Home</span>
        </a>
        <a href="./videos"
            class="flex flex-col items-center justify-center w-16 py-2 rounded-2xl text-neutral-500 hover:text-[#727b46] hover:bg-[#727b46]/10 transition-all duration-300">
